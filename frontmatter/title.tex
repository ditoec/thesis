...
{\huge Integration of Multimodal Human Feedback \\ in a Cognitive Robot
Architecture for \\ Human Preference and Error Situation Handling during
Human Robot Collaboration }\\[4mm]
\rule[0.5ex]{\linewidth}{1pt}\vspace*{-\baselineskip}\vspace{3.2pt}
\rule[0.5ex]{\linewidth}{2pt}\\
\vspace{6.5mm}
{\large By}\\
\vspace{6.5mm}
{\large\textsc{Dito Eka Cahya}}\\
\vspace{11mm}
...
\end{center}
\begin{flushright}
{\small Word count: thirty thousand}
\end{flushright}
\end{adjustwidth*}
\end{SingleSpace}
\end{titlingpage}